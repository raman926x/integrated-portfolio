...
const projects: Project[] = [
  {
    ...
    client: "JPH Engineers Pvt. Ltd.",
    tags: ["Web", "Engineering", "Civil"],
    year: "2026",
    image: projectJPH,
    frame: "browser",
    accent: "acid",
    description:
      "A robust, modern digital presence for a multi-domain engineering firm, balancing complex technical information with clean, evergreen design.",
  },
  {
    slug: "project-2",
    num: "02",
    ...
    accent: "amber",
    description:
      "A streamlined management dashboard designed to cut through red tape—optimizing communications, task assignments, and case records with a distinctly non-bureaucratic UI.",
  },
  {
    slug: "project-3",
    num: "03",
    title: "Sales Invoice UI",
    client: "Accobiz Pvt. Ltd.",
    tags: ["ERP", "Sales", "Brand"],
    year: "2026",
    image: projectACB,
    frame: "browser",
    accent: "electric",
    description:
      "An intuitive sales management dashboard bridging the gap between legacy workflows and digital ERP systems through clear, accessible interface design.",
  },
  {
    slug: "project-4",
    num: "04",
    title: "Quick commerce delivery",
    client: "Ninja Deliveries Pvt. Ltd.",
    ...
    accent: "magenta",
    description:
      "A high-contrast mobile delivery application that merges frictionless e-commerce UX with a bold, uncompromising brand identity.",
  },
];
